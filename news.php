<?php
  ...
  if($row > 0) {
    ...
    while($data = mysqli_fetch_assoc($result)) {
      ...
      $article_dedline = strtotime($article_dedline);
      ...
      <article class="card1">
        ...
        <div class="meta">
          ...
          <div class="date">
            ...
            <?php
              echo date("d M Y",$article_dedline);
            ?>
          </div>
        ...
        <div class="article-content">
          <p>
            <?php
              if($_SESSION['lang']=="en")
                echo nl2br($article_desc_eng);
              else if($_SESSION['lang']=="kz")
                echo nl2br($article_desc_kz);
              else
          ...
          <?php
            ...
            if($row > 0) {
              ...
              while($data = mysqli_fetch_assoc($trendingResult)) {
                ...
                $article_dedline = date("d M Y", $article_dedline);
                ...
                createAsideCard($article_image, $article_id, $article_title, $author_name,$article_dedline);
              }
            }
          ?>
