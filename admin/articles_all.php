          ...
          <ul class="pagination pg-red">
            <?php
              ...
              if(mysqli_num_rows($paginationResult) > 0) {
                ...
                if($page > $total_page) {
                  redirect('./articles_all.php');
                }
                if($page > 1) {
                  echo '
                    <li class="page-item">
                      <a href="articles_all.php?page='.($page - 1).'" class="page-link">
                        <span>&laquo;</span>
                      </a>
                    </li>';
                }
                for($i = 1; $i <= $total_page; $i++) {
                  ...
                  echo '<li class="page-item '.$active.'"><a href="./articles_all.php?page='.$i.'" class="page-link">'.$i.'</a></li>';
                }
                if($total_page > $page){
                  echo '
                    <li class="page-item">
