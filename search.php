    ...
    <div class="card-container">
      <?php
        ...
        if($from_date != "" && $to_date != "") {
          ...
          $searchQuery .= ' AND article_dedline BETWEEN "'.$from_date.'" AND "'.$to_date.'" ';
        }
        ...
        // If both to and from date filter values are same
          ...
          $searchQuery .= ' AND article_dedline ="'.$from_date.'"';
        }
        ...
        // If only to date filter is present
          ...
          $searchQuery .= ' AND article_dedline <= "'.$to_date.'"';
        }
        ...
        if($row  > 0) {
          ...
          while($data = mysqli_fetch_assoc($searchResult)) {
            ...
            createArticleCard($article_title, $article_image, 
                ...
                $category_color, $new, $article_trend, $bookmarked, $article_dedline);
          }
        }
